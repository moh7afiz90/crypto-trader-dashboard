...
export default function JournalPage() {
  ...
  const wins = entries.filter((e) => e.realized_pnl > 0).length
  const losses = entries.filter((e) => e.realized_pnl < 0).length
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Review your closed trades and analyze your performance
        </p>
      </div>
